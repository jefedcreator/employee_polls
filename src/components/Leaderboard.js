...
const mapStateToProps = ({ users }) => ({
    // users: Object.keys(users).sort((a,b) => users[b].questions.length - users[a].questions.length && users[b].Object.keys(answers).length - users[a].Object.keys(answers).length),
  })
