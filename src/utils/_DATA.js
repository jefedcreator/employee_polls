...
export function _saveQuestionAnswer ( authedUser, id, voteId ) {
  return new Promise((resolve, reject) => {
    const answer = voteId == 1 ? "optionOne" : "optionTwo"
...
// function _saveUser({username, password}) {
//   return new Promise((res,rej) => {
//     if (!username || !password) {
//       rej('please provide valide username and password');
//     }
//     const formattedUser = formatUser({username,password})
//     setTimeout(() => {
//       users = {
//         ...users,
